...
<html>
  ...
  <body>
    <div class="div">
        ...
        <p>Sorry, The page you have requested has either been moved or does not exist.<br>
        Your Session_key will be deleted</p><br><br>
        <a class="back" href="../login/signup.php">Back to Home</a>
    </div>
  </body>
</html>
